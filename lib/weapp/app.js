...
exports.getActivePageScopes = getActivePageScopes;
...
var App = /*#__PURE__*/function (_Base) {
  ...
  function App(config) {
    ...
    _this.type = _weAppTypes.BaseType.app;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return this.registerChildren(cfgs, _page["default"]);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return this.registerChild(config, _page["default"]);
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", _super.registerChild.call(this, Object.assign(Object.assign({}, config), {
                  type: _weAppTypes.BaseType.page
                }), Child));
...
function getActivePageScopes(location) {
  ...
  var activeFns = registedPages.filter(function (page) {
    ...
    var pageName = (0, _weAppUtils.getScopeName)(scope);

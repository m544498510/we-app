...
var Page = /*#__PURE__*/function (_Base) {
  ...
  function Page(config) {
    ...
    _this.type = _weAppTypes.BaseType.page;
  ...
  _createClass(Page, [{
    ...
    value: function start() {
      ...
      (0, _singleSpa.registerApplication)((0, _weAppUtils.getScopeName)(scope), {
        ...
        pageScope: (0, _weAppUtils.makeSafeScope)(scope),
    ...
    value: function getRender() {
      ...
      if (render) {
        ...
        if (this.type === _weAppTypes.BaseType.page) {
    ...
    value: function getAppBasename() {
      ...
      var appBasename = this.getData(_weAppTypes.DataName.basename, true) || '';
      return (0, _weAppUtils.ajustPathname)("/".concat(appBasename));
    }
  }, {
    key: "getBasename",
    value: function getBasename() {
      ...
      if (basename) {
        return (0, _weAppUtils.ajustPathname)("/".concat(appBasename, "/").concat(basename));
      }

      return (0, _weAppUtils.ajustPathname)("/".concat(appBasename, "/").concat(productName, "/").concat(appName));
    }
  }, {
    ...
    value: function makeActivityFunction() {
      ...
      if (route === true && !routeIgnore) {
        ...
        activityFunction = function activityFunction(location) {
          ...
          if (routerType === _weAppTypes.RouterType.hash) {
          ...
          var match = [productBasename, "".concat(productBasename, "/")].indexOf(pathname) > -1 && (0, _homepage.matchHomepage)(_this3.compoundScope(_this3)); // 匹配页面路由

          if (!match) {
            match = (0, _weAppUtils.DEFAULTRouteMatch)(Object.assign(Object.assign({}, config), {
              route: route,
    ...
    value: function setCustomProps(customProps) {
      this.setData(_weAppTypes.DataName.customProps, customProps);
    }
  }, {
    key: "load",
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.beforeLoad, [scope]);
              ...
              case 2:
                ...
                component = resourceLoader.mount(url, (0, _weAppUtils.makeSafeScope)(scope), resourceLoaderOpts);
                _context4.next = 7;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.afterLoad, [scope]);
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.beforeMount, [scope]);
              ...
              case 2:
                ...
                _context5.next = 6;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.onMountPrevented, [scope]);
              ...
              case 7:
                ...
                if ((0, _weAppUtils.isValidElement)(container)) {
                  _context5.next = 11;
                  break;
                }
                ...
                (0, _singleSpa.unloadApplication)((0, _weAppUtils.getScopeName)(scope));
                return _context5.abrupt("return");

              case 11:
                render = this.getRender();
                (_a = render === null || render === void 0 ? void 0 : render.mount) === null || _a === void 0 ? void 0 : _a.call(render, component, container, Object.assign(Object.assign(Object.assign({}, this.getData(_weAppTypes.DataName.customProps)), customProps), {
                  context: (0, _context7.getContext)()
                })); // 页面未渲染则认为没有mount

                _context5.next = 15;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.afterMount, [scope]);
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.beforeUnmount, [scope]);
              ...
              case 5:
                ...
                if (container) {
                  render = this.getRender();
                  (_a = render === null || render === void 0 ? void 0 : render.unmount) === null || _a === void 0 ? void 0 : _a.call(render, container, component, Object.assign(Object.assign(Object.assign({}, this.getData(_weAppTypes.DataName.customProps)), customProps), {
                    context: (0, _context7.getContext)()
                  }));
                }
                ...
                url = this.getConfig('url') || [];
                resourceLoader.unmount(url, (0, _weAppUtils.makeSafeScope)(scope), resourceLoaderOpts); // afterUnmount

                _context6.next = 12;
                return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.afterUnmount, [scope]);

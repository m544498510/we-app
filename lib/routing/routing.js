...
var _eventIntercept = require("./event-intercept");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            destination = (0, _helper.parseUri)("".concat(location.protocol, "//").concat(location.hostname).concat(location.port ? ":".concat(location.port) : '').concat(url));
            _context.next = 3;
            return (0, _eventIntercept.runRoutingWithHook)(destination);
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (activeScopes.length === 0) {
              activePages = (0, _singleSpa.checkActivityFunctions)(location);
              activeScopes = activePages.map(function (pageName) {
                return (0, _weapp.getScope)(pageName);
              });
            }

            _context4.next = 4;
            return (0, _hooks.runLifecycleHook)(_weAppTypes.LifecycleHookEnum.beforeRouting, activeScopes);
...
(0, _eventIntercept.setRoutingWithHook)(routingWithHook); // 首次进入执行路由拦截
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            isStarted = true;
            activeScopes = (0, _weapp.getActivePageScopes)(location);
            _context5.next = 6;
            return (0, _eventIntercept.runRoutingWithHook)(location, activeScopes).then(function (isContinue) {
              if (isContinue !== false) {
                (0, _eventIntercept.callCapturedEventListeners)([createPopStateEvent(null)]);
              }
            });

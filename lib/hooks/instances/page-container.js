...
function DefaultCreatePageContainer(param) {
  ...
  var elSkeleton = hookScope.getData('skeletonContainer', true) || (0, _weAppUtils.getElement)(skeletonContainer);

  if ((0, _weAppUtils.isValidElement)(elSkeleton)) {
    ...
    if (!(0, _weAppUtils.isValidElement)(elPageContainer)) {
      var elContent = hookScope.getData('contentContainer', true) || (0, _weAppUtils.getElement)(contentContainer, elSkeleton) || elSkeleton;

      if ((0, _weAppUtils.isValidElement)(elContent)) {
...
var _default = hookPageContainer;

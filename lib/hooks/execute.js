...
exports.getEnabledHookNames = getEnabledHookNames;
...
function getEnabledHookNames() {
  var enabledHookNames = [];
  EnabledHookScopes.forEach(function (_ref) {
    var hookScope = _ref.hookScope;
    var scopeHookNames = (0, _using.getScopeHookNames)(hookScope.scopeName);
...
function matchHookDescRunnerParam(sourceHookScope, forMatchedHookScopes) {
  ...
  var appScopeName = (0, _weAppUtils.getScopeName)(Object.assign(Object.assign({}, sourceHookScope), {
    pageName: ''
  }));
  var productScopeName = (0, _weAppUtils.getScopeName)(Object.assign(Object.assign({}, sourceHookScope), {
    appName: '',
    pageName: ''
  }));
  ...
  var matchedHookScopes = forMatchedHookScopes.map(function (hooksScope) {
    var hookScope = typeof hooksScope === 'string' ? (0, _weapp.getScope)(hooksScope) : hooksScope;
    return hookScope;
    ...
    return !hookScope.pageName && !hookScope.appName && hookScope.product.type === _weAppTypes.BaseType.root;
  });
...
function matchActivePageHookDescRunnerParam(activePageScope) {
  var pageScopeName = (0, _weAppUtils.getScopeName)(activePageScope);
  ...
  var hooksScopes = (0, _using.getHooksScopes)();
...
function matchHookDescRunnerParams(activePageScopes, lifecycleHook) {
  ...
  if (lifecycleHook === _weAppTypes.LifecycleHookEnum.beforeRouting) {
...
function runLifecycleHook(lifecycleHook, activePageScopes, props) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            hookPages = (0, _register.getPageConfigs)().map(function (hookPage) {
              return (0, _weAppUtils.getScopeName)({
            ...
            if (lifecycleHook === _weAppTypes.LifecycleHookEnum.beforeRouting) {
              RootScope = (0, _weapp.compoundScope)();
              activePageScopes.unshift(RootScope);
              RootScopeName = (0, _weAppUtils.getScopeName)(RootScope);
            ...
            activePages = activePageScopes.map(function (activeScope) {
              return (0, _weAppUtils.getScopeName)(activeScope);
            }); // 禁用hook，调用clear
            ...
            if (lifecycleHook === _weAppTypes.LifecycleHookEnum.beforeRouting) {
              ...
              disabledHookDescRunnerParams.forEach(function (_ref4) {
                ...
                var scopeHooks = (0, _using.getScopeHooks)(hookScope.scopeName);
                scopeHooks.forEach(function (_ref5) {
                  ...
                  if (hookDescRunner && 'clear' in hookDescRunner) {
                    scopeHooksRunners.push([hookDescRunner.clear, Object.assign(Object.assign({}, props), {
                      hookName: hookName,
                      pageScope: (0, _weAppUtils.makeSafeScope)(pageScope),
                      hookScope: (0, _weAppUtils.makeSafeScope)(hookScope),
                      opts: opts,
                      matched: false,
                      hookPages: hookPages,
                      activePages: activePages,
                      nextHookDescRunnerParam: Object.assign(Object.assign({}, nextHookDescRunnerParam), {
                        pageScope: (0, _weAppUtils.makeSafeScope)(nextHookDescRunnerParam.pageScope),
                        hookScope: (0, _weAppUtils.makeSafeScope)(nextHookDescRunnerParam.hookScope)
                      }),
                      errorHandler: function errorHandler(error) {
                        return (0, _error.errorHandler)(error, [pageScope]);
                      },
              ...
              enabledHookDescRunnerParams.forEach(function (_ref6) {
                ...
                scopeHooks.forEach(function (_ref7) {
                  var hookDescEntity = _ref7.hookDescEntity,
                      opts = _ref7.opts;
                  var hookPageConfig = hookDescEntity(_weAppTypes.LifecycleHookEnum.page);

                  if (hookPageConfig) {
                    var hookPageName = (0, _weAppUtils.getScopeName)({
                      hookName: hookPageConfig.hookName
                    });
                    var hookPageScope = (0, _weapp.getScope)(hookPageName); // 更新配置
                    ...
                    var hookPageStatus = (0, _singleSpa.getAppStatus)(hookPageName);

                    if (hookPageStatus && ['NOT_LOADED', 'UNLOADING'].indexOf(hookPageStatus) === -1) {
                      (0, _singleSpa.unloadApplication)(hookPageName);
                    }
                  }
                });
              });
            ...
            enabledHookDescRunnerParams.forEach(function (_ref8) {
              ...
              scopeHooks.forEach(function (_ref9) {
                ...
                if (hookDescRunner && 'exec' in hookDescRunner) {
                  ...
                  if (hookPageConfig) {
                    var hookPageScopeName = (0, _weAppUtils.getScopeName)({
                      hookName: hookPageConfig.hookName
                    });
                    hookPageScope = (0, _weapp.getScope)(hookPageScopeName);
                  }
                  ...
                  scopeHooksRunners.push([hookDescRunner.exec, Object.assign(Object.assign({}, props), {
                    ...
                    pageScope: (0, _weAppUtils.makeSafeScope)(pageScope),
                    hookScope: (0, _weAppUtils.makeSafeScope)(hookScope),
                    hookPageScope: (0, _weAppUtils.makeSafeScope)(hookPageScope),
                    opts: opts,
                    matched: true,
                    hookPages: hookPages,
                    activePages: activePages,

...
var Product = /*#__PURE__*/function (_Base) {
  ...
  _createClass(Product, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 6;
                return this.registerChild(childConfig, App);
    ...
    value: function parseAppConfig(config) {
      var parser = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : transformAppConfig;
